...
import FantacyDetail from './components/DetailsPage/StoryDetail/FantasyDetail';
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/smartcontract-detail/03" element={<FantacyDetail />} />
        <Route path="/smartcontract-detail/02" element={<FanfictionDetail />} />
        <Route path="/smartcontract-detail/01" element={<HorrorDetail />} />
